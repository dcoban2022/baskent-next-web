...
const related = [
  ...
  { title: "Dispraksi", desc: "Motor koordinasyon güçlüğü", href: "/dispraksi" },
];
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative overflow-hidden rounded-3xl shadow-xl">
                ...
                <div className="absolute bottom-4 left-4 z-10 rounded-xl bg-white/90 px-4 py-3 shadow-lg backdrop-blur-sm">
                  <p className="text-xs font-semibold uppercase tracking-wide text-gray-500">Hedef Grup</p>
                  <p className="text-sm font-bold text-gray-800">Okul Çağı</p>
                </div>
              </div>
            </div>
          </div>
