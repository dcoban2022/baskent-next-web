const features = [
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="h-10 w-10" stroke="white" strokeWidth={1.5}>
...
const WhyUs = () => {
  return (
    <section className="bg-[#1a1a2e] py-16 md:py-20 lg:py-24">
      <div className="container">
        <div className="mb-12 text-center">
          <span className="mb-4 inline-block rounded-full border border-white/20 px-4 py-1.5 text-sm font-semibold uppercase tracking-wider text-white/80">
            Neden Biz?
          </span>
