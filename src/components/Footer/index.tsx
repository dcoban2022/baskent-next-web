...
const Footer = () => {
  return (
    <footer className="bg-[#0077b6] pt-10 md:pt-12">
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-8 max-w-[360px] lg:mb-10">
              ...
              <div className="mb-4 flex items-start gap-3">
                <svg className="mt-0.5 h-4 w-4 shrink-0 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <div className="mb-2 flex items-center gap-3">
                <svg className="h-4 w-4 shrink-0 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 6.75Z" />
                </svg>
                <p className="text-sm text-white/80">
                  Kurum Müdürü:{" "}
                  <a href="tel:05057141668" className="transition hover:text-white">
                    0 (505) 714 16 68
                  </a>
                </p>
              </div>
              <div className="mb-6 flex items-center gap-3">
                ...
                <p className="text-sm text-white/80">
                  Uzman Danışman:{" "}
                  <a href="tel:05335734564" className="transition hover:text-white">
                    0 (533) 573 45 64
                  </a>
                </p>
              </div>
