          ...
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-12 max-w-[360px] lg:mb-16">
              ...
              <p className="mb-6 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                2004 yılından bu yana dil, konuşma ve öğrenme güçlüklerinde
                uzman ve akademik kadromuzla hizmet veriyoruz.
              </p>
              <div className="mb-4 flex items-start gap-3">
                <svg className="mt-1 h-5 w-5 shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                </svg>
                <p className="text-sm text-body-color dark:text-body-color-dark">
                  Işınlar Mah. İvedik Cad. No:2 (Yenimahalle Girişi, İvedik
                  Metro İstasyon Karşısı), Yenimahalle / Ankara
                </p>
              </div>
              <div className="mb-2 flex items-center gap-3">
                ...
                <p className="text-sm text-body-color dark:text-body-color-dark">
                  Kurum Müdürü: <a href="tel:05057141668" className="hover:text-primary">0 (505) 714 16 68</a>
                </p>
              </div>
              <div className="mb-6 flex items-center gap-3">
                ...
                <p className="text-sm text-body-color dark:text-body-color-dark">
                  Uzman Danışman: <a href="tel:05335734564" className="hover:text-primary">0 (533) 573 45 64</a>
                </p>
              </div>
              {/* Sosyal Medya */}
              <div className="flex items-center gap-4">
                <a
                  ...
                  className="text-body-color transition hover:text-primary dark:text-body-color-dark"
                >
