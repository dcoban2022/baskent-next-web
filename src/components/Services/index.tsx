...
const services = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="h-7 w-7" stroke="#0077b6" strokeWidth={1.5}>
    ...
    <section id="services" className="bg-white py-16 md:py-20 lg:py-24">
      <div className="container">
        <div className="mb-12 text-center">
          <span className="mb-4 inline-block rounded-full bg-blue-50 px-4 py-1.5 text-sm font-semibold uppercase tracking-wider text-[#0077b6]">
            Eğitim Alanlarımız
          </span>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            ...
            >
              <div className="mb-5 rounded-xl bg-blue-50 p-3 w-fit">
                {service.icon}
              </div>
              ...
              <Link
                href={service.href}
                className="text-sm font-medium text-[#0077b6] transition hover:underline"
              >
                Detaylı Bilgi →
              </Link>
            </div>
